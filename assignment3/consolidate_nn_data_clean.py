...
if __name__ == '__main__':
    ...
    ds1_name = 'spam'
    ds2_name = 'credit_default'

    # NOTE: Change last field to your components for each DR
    # for part 3 you’d select some k value via your sse/ll knee or whoever you’re doing it
    ds1_nc = {
        'name': ds1_name,
        'algos': [
            AlgoDS('ICA', 'param_ica__n_components', 60),
            AlgoDS('PCA', 'param_pca__n_components', 4),
            AlgoDS('RP', 'param_rp__n_components', 8),
            AlgoDS('RF', 'param_filter__n', 12),
            ]
        }
    ds2_nc = {
        'name': ds2_name, 
        'algos': [
            AlgoDS('ICA', 'param_ica__n_components', 15),
    ...
    ds1_gmm = {
        ...
        'cluster': gmm,
        'algos': [
            AlgoDS('benchmark', param_gmm, 0),
            AlgoDS('ICA', param_gmm, 60),
            AlgoDS('PCA', param_gmm, 4),
            AlgoDS('RP', param_gmm, 8),
            AlgoDS('RF', param_gmm, 12),
            ]
        }
    ds2_gmm = {
        'name': ds2_name, 
    ...
    ds1_km = {
        ...
        'cluster': km,
        'algos': [
            AlgoDS('benchmark', param_km, 0),
            AlgoDS('ICA', param_km, 60),
            AlgoDS('PCA', param_km, 4),
            AlgoDS('RP', param_km, 8),
            AlgoDS('RF', param_km, 12),
            ]
        }
    ds2_km = {
        'name': ds2_name, 
